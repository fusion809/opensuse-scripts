...
function 0adup {
    ...
    specn=$(cat $HOME/OBS/home:fusion809/0ad/0ad.spec | grep "Version:" | sed 's/Version:\s*//g')
    ...
    if [[ $specn == $mastn ]]; then
         ...
         sed -i -e "s/$specm/$comm/g" $HOME/OBS/home:fusion809/0ad/0ad.spec
         sed -i -e "s/$specm/$comm/g" $HOME/OBS/home:fusion809/0ad-data/0ad-data.spec
